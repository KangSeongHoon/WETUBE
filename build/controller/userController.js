...
exports.postChangePassword = exports.getChangePassword = exports.postEditProfile = exports.getEditProfile = exports.userDetail = exports.getMe = exports.logout = exports.postFacebookLogin = exports.facebookCallback = exports.facebooklogin = exports.postGithubLogin = exports.githubLoginCallback = exports.githubLogin = exports.postLogin = exports.getLogin = exports.postJoin = exports.getJoin = void 0;
...
var postJoin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res, next) {
    var _req$body, name, email, password1, password2, user;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _req$body = req.body, name = _req$body.name, email = _req$body.email, password1 = _req$body.password1, password2 = _req$body.password2;
          ...
          case 10:
            user = _context.sent;
            _context.next = 13;
            return _User["default"].register(user, password2);
...
var facebookCallback = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 17:
            ...
            return _context3.abrupt("return", debug(_context3.t0));
  ...
  return function facebookCallback(_x8, _x9, _x10, _x11) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            res.redirect(_routes["default"].editProfilet);
...
var postChangePassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, res) {
    var _req$body3, oldPassword, newPassword1, newPassword2;

    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _req$body3 = req.body, oldPassword = _req$body3.oldPassword, newPassword1 = _req$body3.newPassword1, newPassword2 = _req$body3.newPassword2;
            _context6.prev = 1;
