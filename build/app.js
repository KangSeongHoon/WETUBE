...
var CokieSotore = (0, _connectMongo["default"])(_expressSession["default"]);
app.set('view engine', "pug"); //서버가 유저로부터 데이터를 받은 형식

app.use((0, _helmet["default"])());
app.set("view engine", "pug");
app.set("views", _path["default"].join(__dirname, "views"));
app.use("/uploads", _express["default"]["static"](_path["default"].join(__dirname, "static")));
